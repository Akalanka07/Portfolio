    ...
    >
      ...
      <div className="flex flex-col gap-4 max-w-2xl z-10 animate-fade-in">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 drop-shadow-lg"
        >
          Akalanka Rathnayaka
        </motion.h1>
      ...
      <Tilt glareEnable={true} glareMaxOpacity={0.3} scale={1.05} className="z-10 mt-12 md:mt-0">
        <div className="relative w-[230px] sm:w-[280px] md:w-[340px] lg:w-[360px] animate-fade-in">
          ...
          {[{
            icon: <SiHtml5 />,
            className: "top-2 left-2 text-blue-400"
          }, {
            icon: <SiCss3 />,
            className: "top-2 right-2 text-blue-500 delay-150"
          }, {
            icon: <SiJavascript />,
            className: "bottom-2 left-10 text-yellow-400 delay-300"
          }, {
            icon: <SiReact />,
            className: "top-[20%] right-0 text-cyan-400 delay-500"
          }, {
            icon: <SiNodedotjs />,
            className: "bottom-[15%] right-10 text-green-500 delay-700"
          }, {
            icon: <SiGit />,
            className: "top-[50%] left-2 text-pink-500 delay-700"
          }, {
            icon: <SiGithub />,
            className: "bottom-0 right-0 text-white delay-300"
          }, {
            icon: <SiPython />,
            className: "top-0 left-[40%] text-blue-300 delay-500"
          }].map((item, index) => (
            <div
              key={index}
