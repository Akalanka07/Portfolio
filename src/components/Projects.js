...
const projectData = [
  {
    ...
    shortDesc: "Big Data + ML for Elephant-Train Collision Prediction",
    longDesc:
      "Analyzed 10+ years of elephant-train collision data using Apache Spark, Snowflake, and Scikit-learn. Built real-time analytics pipelines and predictive models (Random Forest, XGBoost) to identify high-risk days and locations.",
  ...
  },
  {
    ...
    shortDesc: "Mobile app for garage repair management.",
    longDesc:
      "Developed using Flutter & Firebase, Motivo supports real-time service tracking, vehicle history, role-based dashboards, and online payments. Designed for small/medium garages in Sri Lanka with customer/operator modes.",
